...
def hello_world():
    #####（pdf转txt）
    pdf_Base_path = ".._V2.0/data/Upload_pdf"
    txt_Base_Path = ".._V2.0/data/Processed_txt"
    pdfTotxt(pdf_Base_path, txt_Base_Path)

    # ######（txt文本处理）
    inBasePath = '.._V2.0/data/Processed_txt'
    outBasePath = '.._V2.0/data/Txt_pre'
    txtTo_Pre_Data(inBasePath, outBasePath)

    #######（文档预测）
    txtFilePath = '.._V2.0/data/Txt_pre'
    modelBasePath = '.._V2.0/data/model'
