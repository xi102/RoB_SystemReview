...
# data=[]
# f=open('D:/Projects/PythonProjects/NLP_Projects/RoB_SystemReview/data/Txt_pre/Li P, 2010.txt', 'r', encoding='UTF-8')
# for line in f.readlines():
#     data.append(line)
# print(len(data))
# tfv = joblib.load("D:/Projects/PythonProjects/NLP_Projects/RoB_SystemReview/data/model/TF-IDF_vectors_model.m")
# X = tfv.transform(data)
# model=joblib.load('D:/Projects/PythonProjects/NLP_Projects/RoB_SystemReview/data/model/sentence_model_BOA.m')
# pre_label=model.predict(X)
# print(pre_label)
